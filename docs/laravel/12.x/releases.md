...
For all Laravel releases, bug fixes are provided for 18 months and security fixes are provided for 2 years. For all additional libraries, only the latest major release receives bug fixes. In addition, please review the database versions [supported by Laravel](/laravel/12.x/database#introduction).
...
To get started with our new starter kits, check out the [starter kit documentation](/laravel/12.x/starter-kits).
