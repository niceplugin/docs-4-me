...
You may write information to the logs using the `Log` [facade](/laravel/12.x/facades). As previously mentioned, the logger provides the eight logging levels defined in the [RFC 5424 specification](https://tools.ietf.org/html/rfc5424): **emergency**, **alert**, **critical**, **error**, **warning**, **notice**, **info** and **debug**:
...
> [!NOTE]
> If you need to share log context while processing queued jobs, you may utilize [job middleware](/laravel/12.x/queues#job-middleware).
...
> [!NOTE]
> All of your "tap" classes are resolved by the [service container](/laravel/12.x/container), so any constructor dependencies they require will automatically be injected.
